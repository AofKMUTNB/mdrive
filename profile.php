            ...
            <div class="col-lg-12">
                <div class="breadcrumbs-menu">
                    <ul>
                        ...
                        <li><a href="#" class="active">แก้ไขข้อมูลส่วนตัว</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <form id="form_edit_profile">
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            <span>เงินเดือน *</span>
                            <input type="number" name="salary" disabled class="form-control" value="<?=$row['salary']?>">
                        </div>
                        ...
                        <button type="submit" class="btn btn-success">บันทึก</button>
                            ...
                            {
                                ?>
                           <button type="button" onclick="window.location='index.php'" class="btn btn-danger">ยกเลิก</button>
                                <?php

                            }else{
                                ?>
                                <button type="button" onclick="window.location='motorcycle_list.php'" class="btn btn-danger">ยกเลิก</button>
                                     <?php
...
<script>
    ...
    $("#form_edit_profile").submit(function(e) {
        ...
        formData.append("act", "form_edit_profile");
        $.ajax({
            url: "sql.php",
            type: "POST",
            data: formData,
